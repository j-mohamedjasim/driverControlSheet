...
def get_record():
    ...
    cur.execute("""
        SELECT id, date, loc, route, name, scanner, printer, sparebattery, count, requestedClear, isTransferred, leftInBayP1, leftInBayR1, leftInBayP2, leftInBayR2, leftInBayP3, leftInBayR3, bulkLeftP1, bulkLeftP2, bulkLeftP3, bulkLeftP4, bulkLeftP5, bulkLeftP6, isSigned, rdna, timecards
        FROM driver_records
